...
public class StudentRecords extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(35, 25, 170, 40);
        getContentPane().add(schno);
        schno.setBounds(240, 20, 65, 40);
        ...
        jButton1.setBounds(501, 33, 140, 50);
        ...
        cAdm.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Certificate", "Diploma", "Higher Diploma", "Degree" }));
        ...
        pc.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "select", "Certificate", "Diploma", "Higher Diploma", "Degree" }));
        jPanel1.add(pc);
        ...
        jButton2.setBounds(20, 490, 69, 33);
        ...
        jButton3.setBounds(680, 490, 70, 33);
        ...
        jButton5.setBounds(340, 450, 100, 33);
        ...
        jButton6.setBounds(470, 450, 100, 33);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            try{
                ...
                String query = "Select * from newentry where SchNo ="+sno;
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        else
        {
            ...
            else
            {
                ...
                String query = "Update newentry set Name = '" +nm+ "', FatherName = '" +fnm+ "', MotherName = '" +mnm+ "', DOB = '" +dob+ "', Cno = '" +cno+ "', Address = '" +add+ "', DOA = '" +doa+ "', COA = '" +coa+ "' where SchNo ="+sno;
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        else
        {
            try{
                ...
                String check = "Select * from newentry";
                
                String query = "Delete from newentry where SchNo =" +sno;
